...
class ServeCommand extends Command
{
    ...
    public function handle(array $args, Application $app): int
    {
        ...
        $publicPath = escapeshellarg($app->basePath('public'));
        $routerScript = escapeshellarg($app->basePath('router.php'));
        $command = sprintf('php -S %s:%s -t %s %s', $host, $port, $publicPath, $routerScript);
